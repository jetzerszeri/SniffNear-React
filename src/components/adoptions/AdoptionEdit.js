        ...
        <div className="step2">
            ...
            <div>
                ...
                <input
                    type="text"
                    name="city"
                    placeholder="Ingresa la ciudad donde se encuentra la mascota"
                    value={formData.city}
                    onChange={handleChange}
                />
            </div>
            ...
            <div>
                ...
                <ul className="sizeSelector">
                    <li datavalue="pequeño" onClick={() => handleSelectSize('pequeño')} className={formData.size === 'pequeño' ? 'selected' : ''}>
                    ...
                    <li datavalue="mediano" onClick={() => handleSelectSize('mediano')} className={formData.size === 'mediano' ? 'selected' : ''}>
                    ...
                    <li datavalue="grande" onClick={() => handleSelectSize('grande')} className={formData.size === 'grande' ? 'selected' : ''}>
