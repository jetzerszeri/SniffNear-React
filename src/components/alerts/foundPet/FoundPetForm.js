                        ...
                        <li data-value="perro" onClick={() => handleSelectType('perro')} className={selectedType === 'perro' ? 'selected' : ''}>
                            <div>
                                <svg width="55" height="47" viewBox="0 0 55 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M31.7667 37.7497C31.6867 40.1897 29.6767 42.1397 27.2167 42.1397C24.7567 42.1397 22.7567 40.1897 22.6667 37.7497" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M25.7468 27.9197L26.2468 27.8197C26.8868 27.6897 27.5568 27.6897 28.1968 27.8197L28.6968 27.9197C29.3168 27.9197 29.7068 28.6197 29.4068 29.1897L27.2268 31.3997L25.0468 29.1897C24.7468 28.6197 25.1368 27.9197 25.7568 27.9197H25.7468Z" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        ...
                        <li data-value="gato" onClick={() => handleSelectType('gato')} className={selectedType === 'gato' ? 'selected' : ''}>
                            <div>
                                <svg width="56" height="44" viewBox="0 0 56 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M54.2768 24.1397C50.7268 22.8497 47.2168 23.0797 43.7268 24.3997" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M34.7668 6.80981V11.4798" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M45.3169 1.97974C43.9069 3.90974 42.5069 5.84974 40.7869 8.20974" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M21.0466 6.61975V11.4798" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M11.0269 3.03979C12.6369 4.84979 14.2469 6.65979 15.8269 8.43979C24.2369 3.36979 33.8669 4.0098 40.5669 8.4198" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M54.2768 29.9397C50.8968 28.3697 47.4468 27.4497 43.7268 28.6197" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M11.5568 24.1397C8.00684 22.9997 4.48684 22.9897 1.00684 24.3997" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M6.01684 28.3597C4.34684 28.9797 2.67684 29.5897 1.00684 30.2097" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M27.9067 6.46973V11.4797" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M11.5566 28.3597H6.54663" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M11.0268 3.03975C6.51682 11.1297 4.63682 18.9997 6.33682 28.0897C7.59682 34.7897 12.2868 38.6897 18.4168 41.0097C24.3168 43.2397 30.4068 43.3497 36.3268 41.4897C45.8068 38.5197 50.6568 31.8597 50.3168 21.7697C50.1068 15.6397 48.9268 9.70975 46.3468 4.10975C46.1568 3.68975 45.6668 2.33975 45.3168 1.98975" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M18.5967 30.8098C18.5967 30.8098 23.9667 35.8298 28.1567 30.8098C28.1567 30.8098 33.0567 35.5898 36.9067 30.8098" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M15.2368 19.1797C15.2368 19.1797 18.3268 15.6897 20.9168 19.1797" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M34.5767 19.1797C34.5767 19.1797 37.6667 15.6897 40.2567 19.1797" stroke="#363A59" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M26.6068 23.8397H29.4368C30.0268 23.8397 30.4068 24.4797 30.1168 24.9997L28.0168 27.0197L25.9168 24.9997C25.6268 24.4797 26.0068 23.8397 26.5968 23.8397H26.6068Z" stroke="#363A59" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>     
                            </div>
                        </li>
                    </ul>
           ...
           <div className="step8">
                <h2>Verificación</h2>
                    <div className="alertPreview">
                        ...
                        <div id="mi_mapa" class="previewMap"></div>
            </div> 
         )}
